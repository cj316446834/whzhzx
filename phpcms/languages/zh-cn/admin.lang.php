...
//index
$LANG['admin_site_title'] = '武汉中翰整形美容医院 - 后台管理中心';
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将slcms目录设置为644（linux/unix）或只读（NT）';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 网站可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
网站可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.abc.com/';
$LANG['domain_end_string'] = '格式应该为http://www.abc.com/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.abc.com/';
$LANG['site_domain_ex2'] = '格式应该为http://www.abc.com/，请以‘/’结束';
